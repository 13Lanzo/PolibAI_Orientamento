...
COURSE_KPI = {
    ...
    "IMED": {
        ...
        "source_almalaurea": "Recensione_almaLaurea_ingegneria_biomedica.pdf",
        "opis": {
...
def get_kpi_summary_for_prompt(course_id):
    ...
    lines = [
        ...
        f"  - Retribuzione netta media: {alma['retribuzione_netta_media']}€/mese",
